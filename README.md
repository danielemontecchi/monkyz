...
> All tables of many-to-many relationship will have to be defined in config file `db.php` and setting the parameter `visible` to `false`.
...
This command allows you to automatically fill in the [`db.php` config file](#file-db).
...
The following command will be published the views files in: `/resources/views/vendor/lab1353/monkyz`

2. Go to the `/resources/views/vendor/lab1353/monkyz` folder and create a new [file blade](https://www.laravel.com/docs/5.2/blade),
