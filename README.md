...
> **!!!ATTENTION !!!**
> Monkeyz currently only supports one-to-one and many-to-one relationships.
...
Administrator is released under the MIT License. See the `LICENSE.md` file for details.